...
public class CustomerVisiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lay_customer_visite_activity);
    ...
    private class AsyncCallWS extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                dba.open();
                serverResponse = WebService.GeoUpdate(session.getEmpNo(), "GetCustVisit");
                dba.close();
                    ...
                    if (!errored) {
                        ...
                        if (serverResponse != null) {
                            for (int i = 0; i < serverResponse.length(); i++) {
                                ...
                                geoTagUpdate.setCName(serverResponse.getJSONObject(i).getString("CustName"));
                                geoTagUpdate.setGPSLatitude(serverResponse.getJSONObject(i).getString("Latitude"));
                                geoTagUpdate.setGPSLongitude(serverResponse.getJSONObject(i).getString("Longitude"));
                                geoTagUpdate.setUpdatedTStmp(serverResponse.getJSONObject(i).getString("Date"));
                                geoTagUpdateArrayList.add(geoTagUpdate);

                            }
                            GeoTagUpdatesAdapter geoTagUpdatesAdapter=new GeoTagUpdatesAdapter(CustomerVisiteActivity.this,geoTagUpdateArrayList);
                        ...
                        Toast.makeText(CustomerVisiteActivity.this, "Server Error",
