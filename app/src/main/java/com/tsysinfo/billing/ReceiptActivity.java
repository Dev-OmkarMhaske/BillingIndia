...
//set the default according to value
                    ...
                    else
                    {
                        ...
                        Toast.makeText(ReceiptActivity.this, "No User Found", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dba.close();
        toastService = new ToastService(ReceiptActivity.this);
        ...
        textChqDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(
                        ReceiptActivity.this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onClick(View v) {
                ...
                String editPaid=editPaidAmount.getText().toString();
                 ...
                 if (payttype.equalsIgnoreCase("Cash"))
                 {
                    ...
                    {
                        Toast.makeText(ReceiptActivity.this, "Enter Received amount", Toast.LENGTH_SHORT).show();
                        return;
                    }
                     ...
                     {
                         Toast.makeText(ReceiptActivity.this, "Enter Cheque No", Toast.LENGTH_SHORT).show();
                         return;
                     }
                     if( chqdate.toString().equalsIgnoreCase(""))
                     {
                         Toast.makeText(ReceiptActivity.this, "Select Cheque Date", Toast.LENGTH_SHORT).show();
                         return;
                     }
                     if( drawnOn.toString().equalsIgnoreCase(""))
                     {
                         Toast.makeText(ReceiptActivity.this, "Enter Bank Name", Toast.LENGTH_SHORT).show();
                         return;
                     }
                 }
                ...
                else
                {
                    ...
                    Toast.makeText(ReceiptActivity.this, "Please Select  and Confirm bills", Toast.LENGTH_SHORT).show();
        ...
        barCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReceiptActivity.this,FullScannerActivity.class);
                spinCustomer.setSelection(0);
        ...
        try {
            ...
            String sql1 = "select * from " + CustomerTable.DATABASE_TABLE;
            Cursor custCur1 = DataBaseAdapter.ourDatabase.rawQuery(sql1, null);
            if (custCur1.getCount() > 0) {
                    ...
                    if (custCur.getCount() > 0) {
                        ...
                        while (custCur.moveToNext()) {
                            ...
                            if (CalculateDistance.distance(custCur.getDouble(2), custCur.getDouble(1), currLatitude, currLongitude) < Double.parseDouble(session.getDistance())) {
                                ...
                                for (int i = 0; i < spinCustomer.getAdapter().getCount(); i++) {
                                    if (spinCustomer.getAdapter().getItem(i).toString().contains(custCur.getString(0).trim())) {
                                        ...
                                        lv.setAdapter(new ReceiptBaseAdapter(ReceiptActivity.this, ReceiptSearchResults));
                                        LocFlg = 1;
                                        break;
                                    }
                                }
                        ...
                        if(LocFlg == 0){
                            Toast.makeText(ReceiptActivity.this, "Unable to connect to GPS Please Select Customer Manually", Toast.LENGTH_SHORT).show();
                        }
            ...
            if (cur1.getCount() > 0) {
                ...
                if (cur.getCount() > 0) {
                    ...
                    while (cur.moveToNext()) {
                        ...
                        sr.setBillid(cur.getString(3).trim());
                        ...
                        sum = sum + Double.parseDouble(cur.getString(5).trim());

                        results.add(sr);
                    }

                    sum = Math.round(sum * 100.0) / 100.0;
                    balAmount.setText(String.valueOf(sum));
                    Log.e("sum","total"+sum);
                } else {
                    balAmount.setText("");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_out:
               Intent intent= new Intent(ReceiptActivity.this,outActivity.class);
               startActivity(intent);
                return true;
            default:
                ...
                try {
                    ...
                    if (!errored) {
                        ...
                        if (serverResponse != null) {
                            ...
                            if (serverResponse.getJSONObject(0).getString("RecNo").trim().equalsIgnoreCase("No")) {

                                AlertDialog.Builder builder2 = new AlertDialog.Builder(ReceiptActivity.this);
                            ...
                            } else if (!serverResponse.getJSONObject(0).getString("RecNo").trim().equalsIgnoreCase("No")) {

                                recNo=serverResponse.getJSONObject(0).getString("RecNo").trim();
                        ...
                        Toast.makeText(ReceiptActivity.this, "Server Error", Toast.LENGTH_LONG).show();
